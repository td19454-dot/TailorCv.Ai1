...
- SQL
- CI/CD
- [GitHub](https://thetailorcv.com/blog/github-portfolio-optimization) Actions / Jenkins
- TestNG / PyTest / Jest
- Jira
- Regression testing
- Defect tracking
...
[QA automation](https://thetailorcv.com/blog/qa-engineer-resume-2026) Engineer with 4 years of experience building Selenium and Playwright test suites for SaaS applications. Skilled in API testing, CI integration, regression planning, and defect reporting. Improved automated test coverage from 35% to 78% and reduced release validation time by 46%.
