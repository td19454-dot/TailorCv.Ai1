...
**Confirm exactly which documents you will present**, using the official list rather than guessing, and note their expiration dates.

**Gather the originals now**, not the week before you start. If a document needs to be renewed or requested, that process can take time, and discovering a passport has expired three days before a start date is an entirely avoidable problem.

**If you are an international employee, confirm with your international office which document specifically represents your current status** — this is not something to assume based on general knowledge of visa categories, since the specific paperwork varies.

**Resolve any name inconsistencies across your documents in advance** where possible.

**Ask your new employer's HR contact what specifically they will need**, since some provide a checklist proactively and others expect you to know — asking costs nothing and prevents a first-week scramble.

**Keep copies of everything for your own records**, separate from what you hand over to the employer, following the same [record-keeping discipline that matters for any work authorization](/blog/first-job-abroad-practical-checklist) — you will likely need to reference these details again for future paperwork.
