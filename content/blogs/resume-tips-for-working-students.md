---
title: Resume Tips for Working Students
description: How to build a strong resume while balancing classes, part-time work, and projects, with sections, examples, and templates.
date: 2026-07-26
author: TailorCV Team
tags: [students, resume, early career]
category: Job Search
image: public/blog-images/resume-tips-for-working-students.webp
slug: resume-tips-for-working-students
...
You have more material than you think. Part-time jobs, campus roles, internships, freelance gigs, volunteer work, and class projects all count as experience. Frame each with an [action verb](https://thetailorcv.com/blog/best-action-verbs-for-resume) and a result, exactly like professional experience. The fact that you did any of it *while studying full-time* is itself a selling point — it proves you can handle competing priorities, which is what employers mean when they say they want someone reliable.

## Structure a working student's resume

For early-career students, a slightly different structure works best:
...
## Turn ordinary jobs into achievements

The skill that transforms a student [resume](https://www.thetailorcv.com/modify-cv) is reframing routine work as impact. "Cashier" becomes "Handled 100+ transactions per shift with zero register discrepancies." "Campus tour guide" becomes "Led tours for groups of 20+ prospective students and families." "Barista" becomes "Trained three new hires on drink preparation and service standards." The role is ordinary; the framing isn't. This is the same [quantifying-achievements](https://thetailorcv.com/blog/how-to-quantify-achievements-on-resume) skill you'll use your whole career, and a number always beats a vague claim.

## Use class projects and campus involvement

When paid experience is thin, academic and extracurricular work fills the gap convincingly. A capstone project, a research assignment, a hackathon, or a club leadership role all demonstrate real skills — present them like projects with your role, tools, and outcome, as the [projects in resume guide](https://thetailorcv.com/blog/projects-in-resume) and [fresher resume projects that get interviews](https://thetailorcv.com/blog/fresher-resume-projects-that-get-interviews) show. Leadership in a club ("Treasurer, managed a $5K budget") or a sports team ("Captain of a 15-person team") signals responsibility just as strongly as a job. Volunteer work counts too — see [volunteer work on a resume](https://thetailorcv.com/blog/volunteer-work-on-resume).
