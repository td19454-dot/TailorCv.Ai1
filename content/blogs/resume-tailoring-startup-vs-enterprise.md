...
**Weak for enterprise:** Built a pipeline to process customer data.
**Strong for enterprise:** Designed and implemented a customer data ingestion pipeline processing 15M+ records daily, compliant with GDPR and SOC 2 standards, in collaboration with legal, IT security, and product teams.
...
The language is tuned for the audience.
...
A similar shift happens between consulting and industry roles - see [tailoring for a consulting firm vs an industry role](/blog/consulting-vs-industry-tailoring).
...
Your experience does not change.
Your resume should.
