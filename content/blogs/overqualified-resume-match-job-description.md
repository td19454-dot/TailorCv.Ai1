...
Because employers are afraid you will not want it for long.

They worry you will leave in six months.
They worry you will be bored.
...
- Your salary expectations (if mentioned) exceed the role's band
...
You cannot find a role at your level right now.
You need income.
You are willing to take a step back temporarily.
This is also legitimate.

Your resume strategy differs slightly based on which reason applies.
Either way, the goal is the same: reassure the employer that your interest in this role is genuine and sustainable.
...
You do not need to list every role.
...
Both are true.
The second matches a mid-level role's expectations.

### Step 4: Include a "Why This Role" Signal in Your Summary

If you are intentionally downleveling, address it briefly.
Not in detail.
...
You are trying to appear perfectly matched to this specific role.
...
Practice your interview answer with [TailorCV's AI mock interview](https://www.thetailorcv.com/mock-interview).

---

## Honest Salary Signals

Salary expectation is a concern for overqualified candidates.
