...
If you have used any remote collaboration tools, list them explicitly.
Many candidates assume these are obvious.
They are not.
Make them visible.
...
If you have never worked remotely, skip this.
Do not fabricate remote history.
...
**Instead of:** "Managed my own tasks independently."
...
Read [how to match your resume summary to a job description](https://thetailorcv.com/blog/resume-summary-match-job-description) for the full framework.
...
Remote companies have different working cultures.
Some are fully async.
