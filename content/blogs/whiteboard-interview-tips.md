---
title: How to Pass a Whiteboard Interview
description: Think out loud, structure your approach, and stay calm in a live whiteboard interview, with a step-by-step method and practice tips.
date: 2026-07-26
...
On a whiteboard, the final answer matters less than you'd think. Interviewers are watching your problem-solving process, your communication, how you handle hints, and how you respond when stuck. They want to know what it's like to work through a hard problem *with* you. Once you internalize that, the pressure drops — you're not performing a magic trick, you're collaborating on a problem out loud.

## Think out loud — silence is the enemy

The single biggest mistake is going quiet. If you stop narrating, the interviewer can't see your reasoning and can't help you. Talk through what you're considering, why you're choosing one approach over another, and where you're uncertain. Narrating also invites hints — interviewers often nudge you forward when they hear your thinking. This is the same principle as a strong [behavioral answer](https://thetailorcv.com/blog/behavioral-interview-questions-and-answers): make your thought process visible.

## Structure before you solve

Don't dive straight into a solution. Follow a clear sequence:

1. **Restate the problem** in your own words to confirm understanding.
2. **Ask clarifying questions** about inputs, constraints, and edge cases.
3. **Work through an example** by hand to build intuition.
4. **Outline an approach** and state its trade-offs before writing anything.
5. **Then implement**, explaining as you go.

This structure signals seniority and prevents the panic of an unplanned start. It mirrors how you'd break down any complex task, including a [case interview](https://thetailorcv.com/blog/case-interview-preparation-guide-2026).
...
## Handling a problem you don't know

Sometimes you'll get a problem you can't immediately crack. Don't pretend — instead, show how you attack the unknown: break it into smaller pieces, try a simpler version, and reason from first principles out loud. Interviewers value seeing you make progress on something hard far more than seeing you rattle off a memorized answer. Honesty plus method beats bluffing every time, the same way [honesty on your resume](https://thetailorcv.com/blog/should-you-lie-on-your-resume) beats exaggeration.
