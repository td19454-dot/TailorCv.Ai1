...
Read [how to make your resume ATS-friendly](https://thetailorcv.com/blog/how-to-make-resume-ats-friendly) for the complete rules.
...
Make sure every one that applies to you appears in your resume.
...
After that, use whichever the JD uses more.
...
Before: "Worked with data to support the team."
After: "Built Python and SQL pipelines to deliver weekly product analytics to 6 cross-functional stakeholders, reducing reporting lag by 3 days."

Read [how to quantify resume achievements](https://thetailorcv.com/blog/how-to-quantify-resume-achievements) and [best action verbs for resume](https://thetailorcv.com/blog/best-action-verbs-for-resume).
...
**The Fix:**
You cannot change your actual title.
But you can bridge the gap in your summary.

Lead with the target title in your professional summary:
"Marketing Manager with 4 years of content strategy and campaign management experience..."
...
For a full pre-submission checklist, read [resume matching checklist](https://thetailorcv.com/blog/resume-matching-checklist).
...
Focus on the ones relevant to your resume. You may already be doing some right. Use [TailorCV's checker](https://www.thetailorcv.com/solutions) to identify which specific ones affect your application.
...
None require a complete resume rewrite.
Most require one targeted change.

Start by running your resume through [TailorCV](https://www.thetailorcv.com/solutions).
