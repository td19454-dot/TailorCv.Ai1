---
title: "Resume Format for South Korea - The Korean Ireryeokseo"
description: A structured, tabular document with a photo and personal details, plus a self-introduction essay that Western candidates have no equivalent for. What Korean employers actually expect.
date: 2026-08-24
author: TailorCV Team
tags: [South Korea Jobs, Resume Tips, Asia, International Students]
category: Resume Tips
image: public/blog-images/south-korea-resume-format-guide.png
slug: south-korea-resume-format-guide
keywords: korean resume format, ireryeokseo, jagi sogaeseo, resume for jobs in korea, korea cv photo
showcase: none
---
...
**Growth and perseverance are central themes.** Describing a genuine difficulty and what you learned from it is expected rather than risky.

**Specificity still wins.** Generic statements about passion and dedication appear in every application. A concrete story with a real outcome does not.

**Write it in Korean if the role is Korean-language.** If your Korean is not strong enough, that is meaningful information about the role's suitability. For English-language employers, a strong English version is fine.

**Respect the character limits exactly.** They are not suggestions, and online forms enforce them.

## When to use a Western resume instead

Not every employer expects the Korean format.

**Foreign multinationals in Korea** generally run Western processes and expect a standard resume and cover letter.
...
**The rule: follow the advert.** If the posting is in English and the company is international, use a Western resume. If it is in Korean and the company is domestic, use the Korean format — and if they supply a template, use theirs.

## Preparing the documents you will actually be asked for
...
**Start all of it before you have an offer.** Every one of these is obtained in your home country, and doing it after you have moved is dramatically harder. This is the single most common cause of a delayed start date for foreign hires in Korea.

## Common formatting errors and how the document is read

Small things that shape the impression.

**Korean name order.** If you write a Korean name, family name comes first. If your name is not Korean, write it as you normally would and consider adding a Korean transliteration, which helps colleagues address you.

**Be precise with dates.** Korean documents use year-month-day order, and consistency matters in a document that is read as a formal record.

**Do not inflate.** Korean employers verify education and employment histories, and a discrepancy found at the verification stage ends the process.
...
## Adapting your experience for a Korean reader

The same facts land differently depending on how they are framed.
...
**Certifications again.** It is worth repeating because international candidates consistently under-list them: professional qualifications, technical certifications and standardised test scores all carry real weight here.

## The interview that follows the documents
...
**Formality matters.** Business dress, a slight bow on greeting, and receiving a business card with both hands and reading it before putting it away. These are small courtesies and getting them right signals that you have taken the market seriously.

**"Why Korea?" is asked seriously.** Employers want to know whether you will stay, and a vague answer about interest in the culture is weaker than a specific one about the industry, the company or your language study.
...
- [ ] Employer type identified — domestic or international
- [ ] Company template used if one is supplied
- [ ] Professional photo taken
- [ ] Personal details completed to Korean convention
- [ ] Major and institution stated clearly
- [ ] Certifications listed prominently
- [ ] TOPIK and TOEIC scores included
- [ ] Jagi sogaeseo written to the specified prompts
- [ ] Character limits respected exactly
- [ ] Korean-language version proofread by a native speaker

## Scenarios

### Scenario 1: You are applying to Samsung's global track

Use their form. Global recruitment tracks usually supply their own English-language templates, and following them exactly is the whole instruction.

### Scenario 2: You are applying to a Korean startup in Pangyo

A Western resume is usually fine, particularly at internationally-minded companies. Check the advert's language, and if it is in Korean, so is your application.

### Scenario 3: You have been asked for a jagi sogaeseo and have no idea where to start

Answer the prompts literally, one at a time, with a specific story for each and a concrete outcome. Do not write a Western cover letter and hope — the two documents do genuinely different jobs.

> **Tip:** Get a professional application photograph taken. Korea has an entire industry devoted to them for exactly this reason, and a casual crop next to properly-shot competitors reads as not having understood the market.

## Do's and Don'ts

### Do

- Use the company's template if one is supplied
- Include a formal professional photo
- List certifications prominently
- State TOPIK and TOEIC scores
- Answer jagi sogaeseo prompts specifically
- Respect character limits exactly

### Don't

- Substitute your own design for a required form
- Use a UK or US resume for a domestic Korean employer
- Treat the jagi sogaeseo as a cover letter
- Omit your major — it matters for hiring and for visas
- Use a casual photograph
- Write in Korean beyond your actual ability

## Common Mistakes

- **Ignoring the supplied template.** Substituting your own design reads as not following instructions.
- **Treating the jagi sogaeseo as a cover letter.** It is a longer, narrative, prompt-driven document.
- **Omitting the photo.** It is standard and its absence is conspicuous.
- **Understating certifications.** Korea values formal credentials highly.
- **Leaving out TOPIK.** It is the single clearest signal of your Korean ability.
- **Exceeding character limits.** They are enforced, not advisory.
...
### What is an ireryeokseo?

The Korean resume — a structured, often tabular factual record with a photo and personal details. Many companies supply their own template to complete.

### What is a jagi sogaeseo?

A self-introduction essay answering set prompts about your background, motivation, character and goals. It is longer than a Western cover letter and genuinely read.

### Do I need a photo?

For domestic Korean employers, yes, and a formal professionally taken one. International employers and multinationals generally do not require it.

### Can I use my normal Western resume?

For foreign multinationals, Coupang and many startups, yes. For domestic Korean employers, use the Korean format — and their template if they supply one.

### Should I include my TOPIK score?

Absolutely. It is a concrete, verifiable measure of Korean ability that employers understand immediately, and it also matters for the points-based residence visa.

### How long should the jagi sogaeseo be?

As long as the specified character limits allow, and no longer. The limits are enforced by the application forms themselves.
### What documents do I need beyond the resume?

An apostilled degree certificate, official transcripts, usually a criminal background check, and certified Korean translations. All are obtained in your home country, so start early.

### Does Korea require an apostille or consular legalisation?

Korea is party to the Apostille Convention, so documents from member countries need an apostille rather than full legalisation.
