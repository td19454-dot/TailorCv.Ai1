---
title: Campus Placement With Low CGPA 2026 - What Actually Works
description: A low CGPA closes some doors and not others. Which companies still consider you, how to build a profile that outweighs the number, and how to answer the question in interviews.
date: 2026-08-20
...
**Backlogs are frequently a separate filter** — many companies require none current, some require none ever. This is often a bigger barrier than CGPA itself — see [the campus placement backlog guide](https://thetailorcv.com/blog/campus-placement-backlog-guide).
...
**Use referrals.** A referred application bypasses the filter that would otherwise remove you. Seniors from your college who were placed are the natural starting point — see [networking messages for referrals](https://thetailorcv.com/blog/networking-messages-for-referrals).
...
**One deployed project with real users.** This is the highest-leverage thing available to you. Not a repository — something live, with a link, that someone other than you has used. It demonstrates in one line what your transcript denies, and it gives an interviewer something concrete to discuss instead of your marks. See [choosing a final year project for placements](https://thetailorcv.com/blog/final-year-project-for-placement).

**An internship, however small.** External validation carries weight precisely because it comes from someone who is not you and not your college — see [converting an internship into a PPO](https://thetailorcv.com/blog/internship-to-ppo-conversion-guide).

**A real GitHub profile** with commit history and README files. Reviewers open it, and for a candidate whose academics are weak it does disproportionate work — see [how to optimise your GitHub profile](https://thetailorcv.com/blog/github-profile-for-job-search-2026).
...
**Strong aptitude and DSA.** These are tested directly rather than inferred from your CGPA, which makes them the fairest ground available to you — see [the campus placement aptitude test guide](https://thetailorcv.com/blog/campus-placement-aptitude-test-guide) and [the DSA roadmap](https://thetailorcv.com/blog/campus-placement-dsa-roadmap).
...
Your resume has to clear screening either way. [Check your ATS score free](https://www.thetailorcv.com/solutions).
