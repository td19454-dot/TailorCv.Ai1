...
| Required method | A/B testing | Missing | Ran campaign tests in internship | Add bullet |
| Required outcome | Improve retention | Experience section | Increased repeat purchases 12% | Strengthen |

---

## Step 1: Pull Keywords from the [job description](https://thetailorcv.com/blog/job-description-keyword-extraction-guide)
...
If a term appears in the title, first paragraph, or requirements section, treat it as high priority.

---

## Step 2: Check Your Resume Honestly
...
- Present but weak
- Missing but true
- Missing and not true

Only add keywords that are honest. ATS matching helps you get reviewed; interviews expose exaggeration.

---

## Step 3: Add Keywords in Natural Places

Good places to add missing terms:

- [resume headline](https://thetailorcv.com/blog/how-to-write-resume-headline)
- Summary
- Skills section
- Project title
- Work bullet
...
Avoid dumping a long keyword block at the bottom.
...
I am targeting roles where I can use resume keyword mapping process, practical problem solving, and measurable execution to support business outcomes. My strongest examples include improving a process, building a project, coordinating with stakeholders, and using relevant tools to deliver a clearer result.
