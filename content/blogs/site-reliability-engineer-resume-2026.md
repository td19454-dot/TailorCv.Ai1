...
Programming and Automation: Python, Go, Bash, Ansible, custom tooling
Observability: Prometheus, Grafana, Datadog, ELK Stack, Jaeger, Splunk, OpenTelemetry, PagerDuty
