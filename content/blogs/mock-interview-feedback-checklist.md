...
Anything below 3 needs revision.

---

## Common Fixes

If answers are too long, use STAR.

If answers are too vague, add numbers.

If answers sound memorized, practice with variations.

If technical answers are confusing, explain the problem before the tool.
...
I am targeting roles where I can use [mock interview](https://thetailorcv.com/blog/mock-interview-practice-online-free-ai) improvement loop, practical problem solving, and measurable execution to support business outcomes. My strongest examples include improving a process, building a project, coordinating with stakeholders, and using relevant tools to deliver a clearer result.
