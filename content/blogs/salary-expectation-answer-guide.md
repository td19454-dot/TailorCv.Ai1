...
- Provide a research-based salary range that reflects your flexibility and interest in the role.
- If asked about salary too early, request more information about the role's responsibilities before giving a number.
- Always present a salary range where the lower end is still acceptable and avoid underselling yourself.
- Common mistakes include saying "anything is fine," using current salary as a reference, and not researching before naming a figure.
- Optimize your application materials to align closely with the specific job description, using relevant keywords and measurable results.


[salary expectation](https://thetailorcv.com/blog/salary-negotiation-guide) questions can feel uncomfortable because answering too low costs money and answering too high can create anxiety. The best answer is researched, flexible, and tied to the role.
...
Research-based range + flexibility + interest in role

Example:

Based on the role scope and current market data, I am targeting a range of $85,000 to $95,000. I am flexible depending on the full compensation package, growth opportunity, and responsibilities.
...
I would like to understand the responsibilities and expectations a little more before giving a firm number. Could you share the budgeted range for this role?
...
Give a range where the lower number is still acceptable. Do not give a range that starts below your real minimum.
...
I am targeting roles where I can use [salary expectation](https://thetailorcv.com/blog/salary-negotiation-guide) answer, practical problem solving, and measurable execution to support business outcomes. My strongest examples include improving a process, building a project, coordinating with stakeholders, and using relevant tools to deliver a clearer result.
...
Salary expectation answers should sound calm and prepared. Practice this answer before HR rounds with the [AI mock interview tool](/mock-interview), and keep your resume strong with the [ATS checker](/solutions).
...
Customize it for every serious application. That does not mean rewriting everything. Usually, you update the headline, summary, skills order, 3-5 bullet points, and any linked proof that supports the target role. For a faster process, use the [5-minute resume tailoring guide](https://thetailorcv.com/blog/how-to-tailor-resume-in-5-minutes) with the [resume customization checklist](https://thetailorcv.com/blog/resume-customization-checklist).

### Should I add every keyword from the [job description](https://thetailorcv.com/blog/job-description-keyword-extraction-guide)?

No. Add only the keywords that honestly match your experience. Keyword stuffing can make your application look robotic, and it can hurt you in interviews when you cannot explain a skill you listed. Use the [resume keywords guide](https://thetailorcv.com/blog/resume-keywords-guide) and [hidden keywords in job description](https://thetailorcv.com/blog/hidden-keywords-in-job-description) guide to choose terms naturally.
