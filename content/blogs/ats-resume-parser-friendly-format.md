...
The small formatting choices matter too. Use [Resume Margins, Spacing, and Formatting](https://thetailorcv.com/blog/resume-margins-spacing-formatting) to keep the page readable, check the [Resume File Format Guide](https://thetailorcv.com/blog/resume-file-format-guide) before exporting, and review [Chronological vs Functional Resume](https://thetailorcv.com/blog/chronological-vs-functional-resume) if you are considering a non-standard structure.
...
Upload your resume to the [ATS score checker](https://www.thetailorcv.com/solutions) and check whether formatting issues are hurting your score.
