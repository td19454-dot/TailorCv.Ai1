...
While you verify any opportunity, keep your actual job search moving with the [free ATS score checker](https://www.thetailorcv.com/solutions) so a scam doesn't cost you momentum on legitimate applications.
...
4. **Never send money or sensitive documents** before a verified, in-person or video-confirmed offer process.
5. **Trust your instincts on pacing** - real hiring processes almost always include multiple structured steps, not an instant offer.
...
- If a "recruiter" reaches out cold, verify them the same way you'd verify any [cold email from a recruiter](https://thetailorcv.com/blog/how-to-write-cold-email-to-recruiter) works in the other direction - legitimate outreach is verifiable
...
Remote postings are targeted more often simply because there's no in-person verification step, but most remote jobs are completely legitimate. Apply the same verification steps regardless of format - see [remote job search guide](https://thetailorcv.com/blog/remote-job-search-guide).
