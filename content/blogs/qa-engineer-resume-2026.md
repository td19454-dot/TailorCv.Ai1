...
QA Automation Engineer with 5 years of experience testing web and API applications. Built Selenium and Playwright automation frameworks covering 600+ test cases, reducing regression testing time from 3 days to 4 hours. Reduced production defect escape rate from 12% to 3% through risk-based testing and CI-integrated automation. Proficient in Java, Python, Selenium, Cypress, Postman, and Jenkins.
...
Automation Tools: Selenium WebDriver, Playwright, Cypress, Appium (mobile), TestCafe, Puppeteer
...
## Best ATS Keywords for QA Engineer Resume
...
## How to Write QA Resume Bullet Points

Formula:

Built / Reduced / Automated / Tested + [test framework or coverage] + [application context] + [time saved, defect reduction, or coverage improvement]

### Weak Bullet Points

- Wrote test cases and executed tests
...
Show defect escape rate reduction, test coverage percentage, regression time savings, or bugs caught before production.
