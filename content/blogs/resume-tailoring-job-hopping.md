...
- Startup shutdown
- Relocation
- Career pivot (deliberate and explained)
- Company closure
...
Important: do not leave unaccountable gaps. If you omit a 3-month role and it creates a 6-month gap, you may need to explain the gap instead. Read [how to explain resume gaps](https://thetailorcv.com/blog/how-to-explain-resume-gaps) for the right approach.
...
Tailor the emphasis and framing based on who is reading your resume.
The same history reads differently in different contexts.
...
Add context to short roles.
Group contract work under one header.
Lead every role with a real result.
Tell a growth narrative in your summary.
