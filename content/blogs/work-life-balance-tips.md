...
- Reduced creativity and productivity (paradoxically, overwork reduces output quality)
- Higher turnover and career instability
...
Overcommitment is a leading cause of poor balance. Politely decline or renegotiate when your plate is full:
"I'd like to help, but I'm at capacity with [priorities]. Can we reprioritize or find another timeline?"
...
If your job consistently demands unsustainable hours and the culture won't change, a job change may be the real solution. Optimize your resume with the [TailorCV ATS score checker](https://www.thetailorcv.com/solutions) and target companies with healthier cultures.
