---
title: "Relocating for Your First US Job - Cost of Living, Done Properly"
description: A higher salary in an expensive city is frequently a lower real income than a smaller salary somewhere cheaper. Comparing offers by cost of living, not by the headline number, is the single most valuable arithmetic a new graduate can do.
date: 2026-08-23
author: TailorCV Team
tags: [USA Jobs, New Grad, Career Advice, Job Search, Relocation]
...
**Negotiate it if it is not offered.** Relocation support is frequently one of the [more flexible parts of an offer](/blog/usa-offer-negotiation-new-grad) even when base salary is fixed, because it is a one-time cost rather than an ongoing commitment.
...
**Remember that a first job is rarely a permanent choice.** [Moving between employers and cities at the two-year mark is entirely normal](/blog/usa-startup-vs-big-tech-new-grad), which lowers the stakes of a first-city decision considerably. Optimise for a good start, not a lifetime plan.
