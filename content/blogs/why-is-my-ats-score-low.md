...
## 4. You Are Using a Generic Resume

Sending the same resume to every job means it is not tailored to any of them, so the keyword match stays low.

**Fix:** Tailor each resume to the specific posting. Learn how in [how to tailor your resume for every job](https://thetailorcv.com/blog/how-to-tailor-resume-for-every-job).
...
The opposite problem - cramming in keywords unnaturally - can be flagged and also hurts readability for human reviewers.

**Fix:** Use keywords in context, within real sentences and accomplishments.
...
**Fix:** Include both the full term and the acronym: "Search Engine Optimization (SEO)."

---

## 12. Wrong File or Corrupted Export

Unusual file types, special characters, or broken exports can lower parseability.

**Fix:** Stick to standard PDF or DOCX and avoid special symbols in headings.

---

## How to Diagnose Your Low Score Fast

| Symptom | Likely Cause | Quick Fix |
|---|---|---|
| Very low keyword match | Generic resume | Tailor to the job |
| Sections missing in report | Complex formatting | Use single-column template |
| Score won't read at all | Image-based PDF | Re-export as text PDF |
| Weak experience score | No metrics | Add quantified results |
...
Anything below 60 is at high risk of being filtered out. Aim for 80+. See [what is a good ATS score](https://thetailorcv.com/blog/what-is-a-good-ats-score).
