---
title: Campus Placement Preparation Timeline 2026 - Semester by Semester Plan
description: A realistic year-by-year plan for campus placements, from first year to the placement season itself. What to build when, when to start aptitude prep, and how to avoid the last-semester panic that costs students offers.
date: 2026-08-12
...
Before the season starts, make sure your resume actually parses - run it through the [free ATS score checker](https://www.thetailorcv.com/solutions).
...
**Solve problems consistently.** Two or three problems a week beats forty in one weekend before placements. Consistency is what builds the pattern recognition that coding rounds test. The approach is covered in [the campus placement coding round guide](https://thetailorcv.com/blog/campus-placement-coding-round-guide).
...
**Start using version control.** Put your work on GitHub from now on. By the time placements arrive you will have a history rather than a panic-created account with three commits. See [how to optimise your GitHub profile](https://thetailorcv.com/blog/github-profile-for-job-search-2026).
...
**Begin aptitude preparation.** This is the highest-return decision available to you, because aptitude eliminates more students than any other round and is the most improvable through practice. Quantitative aptitude, logical reasoning, and verbal ability. Thirty minutes a day from semester 5 puts you far ahead of someone starting in semester 7. Details in [the campus placement aptitude test guide](https://thetailorcv.com/blog/campus-placement-aptitude-test-guide).

**Deepen DSA.** Move from basic problems to medium difficulty. Focus on patterns rather than memorising solutions.

**Start your major project.** The one that goes on your resume and gets discussed in interviews. Choose something you can explain the decisions behind - see [choosing a final year project for placements](https://thetailorcv.com/blog/final-year-project-for-placement).

**Apply for summer internships.** The single highest-value action of the year, because a good internship frequently converts into a pre-placement offer, and a PPO means you enter placement season with an offer already in hand. See [converting an internship into a PPO](https://thetailorcv.com/blog/internship-to-ppo-conversion-guide).

### Semester 6

**Do the internship.** Treat it as a six-week interview, because that is what it is.

**Write your resume properly.** Not the night before the first company. Build it now, get it reviewed, and iterate. The common errors are catalogued in [campus placement resume mistakes](https://thetailorcv.com/blog/campus-placement-resume-mistakes), and what gets you through the first filter in [how to get shortlisted for campus placement](https://thetailorcv.com/blog/how-to-get-shortlisted-for-campus-placement).

**Decide your target.** Service-based companies, product-based companies, or both. They require different preparation, and trying to prepare identically for both is how students end up mediocre at each. The differences are set out in [service-based vs product-based companies](https://thetailorcv.com/blog/service-based-vs-product-based-companies).
...
**Prepare the HR round properly.** Students over-prepare technically and under-prepare here, then lose offers at the final stage. See [campus placement HR interview questions](https://thetailorcv.com/blog/campus-placement-hr-interview-questions).

**Practise group discussions** if your target companies use them - see [campus placement group discussion tips](https://thetailorcv.com/blog/campus-placement-group-discussion-tips).
...
Many students do both badly. Pick one as primary. The specifics are in [resume for campus placement for non-CSE branches](https://thetailorcv.com/blog/resume-for-campus-placement-non-cse).
...
Target companies with lower or no CGPA criteria, focus on off-campus routes where skill is weighted more heavily, and build a project portfolio strong enough to make the case on its own. See [campus placement vs off-campus](https://thetailorcv.com/blog/campus-placement-vs-off-campus).
...
Make sure the resume behind all this preparation actually gets read. [Check your ATS score free](https://www.thetailorcv.com/solutions).
...
Then get the supporting pieces right before the season, not during it. Write and review your resume using [how to get shortlisted for campus placement](https://thetailorcv.com/blog/how-to-get-shortlisted-for-campus-placement), avoid the errors in [campus placement resume mistakes](https://thetailorcv.com/blog/campus-placement-resume-mistakes), rehearse HR answers out loud following [campus placement HR interview questions](https://thetailorcv.com/blog/campus-placement-hr-interview-questions), and run the file through the [free ATS score checker](https://www.thetailorcv.com/solutions) so it survives the first automated filter.
