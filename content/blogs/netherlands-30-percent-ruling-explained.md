---
title: "The Dutch 30% Ruling Explained for International Hires"
description: A tax facility that can move your take-home pay more than any salary negotiation you will ever win — and one most candidates never think to ask about until it is too late.
date: 2026-08-24
author: TailorCV Team
tags: [Netherlands Jobs, Salary, Europe, Career Advice]
category: Career Advice
image: public/blog-images/netherlands-30-percent-ruling-explained.png
slug: netherlands-30-percent-ruling-explained
keywords: 30 percent ruling netherlands, dutch tax benefit expats, netherlands salary after tax, 30 ruling conditions, working in netherlands tax
showcase: none
---
...
The premise is straightforward. Someone recruited from abroad to work in the Netherlands incurs costs a local hire does not: [relocation](/blog/first-job-abroad-practical-checklist), temporary [housing](/blog/remote-job-search-guide), travel home, the general friction of setting up a life in a new country. The Dutch government calls these **extraterritorial costs**.

Rather than making everyone [document](/blog/campus-placement-document-checklist) those costs individually, the 30% ruling offers a flat alternative: a defined portion of your [salary](/blog/how-to-negotiate-salary-offer) is treated as a tax-free reimbursement of those costs.
...
**The alternative still exists.** If you do not qualify for the ruling, or if your actual extraterritorial costs exceed what the ruling would give you, an [employer](/blog/how-recruiters-spot-generic-resumes) can reimburse the genuine documented costs tax-free instead. It is more administrative work and it is rarely worth it, but it is there.
...
**You and your employer must apply jointly**, within a defined period after your employment starts. Apply within that window and it can be backdated to your [start date](/blog/notice-period-negotiation-guide); apply later and it starts from a later [point](/blog/aptitude-psychometric-test-tips).
...
There is a **substantially lower threshold for employees under 30 who hold a Dutch master's [degree](/blog/how-to-list-education-on-resume) or an equivalent foreign qualification.** This exception exists precisely so that recent graduates are not priced out of the facility, and it is the single most useful thing on this page for someone in their twenties.
...
**It does not reduce your [pension](/blog/first-90-days-new-job) or your social security in a way you should ignore.** Because part of your remuneration is treated as an allowance rather than salary, it can affect pension accrual and certain benefit calculations that are based on salary. For a young graduate this is usually a small consideration, but it is not zero, and an employer's pension provider can tell you exactly how they treat it.
...
- [ ] Ruling eligibility raised in the first salary conversation
- [ ] Confirmed whether the offered gross is the same either way
- [ ] Under-30 master's threshold checked if it applies to you
- [ ] Current percentage, duration and cap verified with the Belastingdienst
- [ ] Joint application submitted inside the window after your start date
- [ ] Confirmation letter from the tax authority received and stored
- [ ] Payslips checked to confirm the ruling is actually being applied
- [ ] Transfer conditions understood before changing employer
- [ ] Net, not gross, used when comparing offers
...
- Leave the [application](/blog/how-many-jobs-should-you-apply-to-per-day) until after the window closes
- Take a colleague's [experience](/blog/resume-matching-experienced-professionals) from a few years ago as current
