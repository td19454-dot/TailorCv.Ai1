...
Third-year B.Com (Finance) student at Delhi University with strong Excel, financial modeling, and accounting skills. Completed a case study competition project on DCF valuation and working capital management. Seeking an investment banking or corporate finance internship to develop analytical and deal skills.
...
- Year of graduation
- Honors or distinction if applicable

If your GPA is below the threshold, simply leave it off.
...
Research: Market research, competitor analysis, consumer surveys

### Example for Finance Internship

Technical: MS Excel (VLOOKUP, PivotTables, basic financial modeling), PowerPoint, basic SQL
Financial Concepts: Time value of money, ratio analysis, financial statements, DCF basics
Tools: Bloomberg (academic access), FactSet (if available)
...
- Competition wins
- Dean's list or honors mention
- Leadership positions in clubs or student organizations
