...
Creating an ATS-compatible resume requires attention to detail, and many candidates make common mistakes that could jeopardize their chances. Here are some pitfalls to watch out for:
...
Text-based PDFs usually pass. Image-based PDFs do not, because there is no readable text.
