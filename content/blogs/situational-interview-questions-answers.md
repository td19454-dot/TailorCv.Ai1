...
## 15 Common Situational Questions

### 1. "What would you do if you disagreed with your manager's decision?"

"I would first seek to understand their reasoning by asking clarifying questions privately. If I still disagreed, I would present my perspective with data, not emotion. If the decision stood, I would commit fully to execution while documenting my concerns if appropriate."

### 2. "What would you do if you missed a deadline?"

"Immediately inform stakeholders with the reason, revised timeline, and mitigation plan. Then analyze what caused the miss and implement process changes to prevent recurrence."
...
"Escalate to my manager or facilitate a meeting between stakeholders to align on priority. Document the agreed order and communicate trade-offs transparently."

### 5. "What would you do if you made a mistake that affected production?"

"Own it immediately, assess impact, implement a fix, communicate to affected parties, and conduct a blameless post-mortem to prevent recurrence."
...
- Your manager takes credit for your work in a meeting
- You need to deliver bad news to a client
- You are overwhelmed with workload
- Company direction changes and your project is deprioritized

For manager-level scenarios, see [manager round questions](https://thetailorcv.com/blog/manager-interview-round-questions-guide). For [case interviews](https://thetailorcv.com/blog/case-interview-preparation-guide-2026), situational thinking is foundational.

---

## Situational Questions by Interview Type

| Type | Example focus |
|------|---------------|
| [HR round](https://thetailorcv.com/blog/hr-round-interview-questions-answers) | Policy, ethics, culture |
| [Manager round](https://thetailorcv.com/blog/manager-interview-round-questions-guide) | Team dynamics, delivery |
| [Panel interview](https://thetailorcv.com/blog/panel-interview-tips-strategies) | Consistent values across answers |
| [Group interview](https://thetailorcv.com/blog/group-interview-tips-strategies) | Collaboration scenarios |
