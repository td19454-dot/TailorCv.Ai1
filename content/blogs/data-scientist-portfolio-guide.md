...
- Documented data sources and licensing
...
- **Kaggle** for notebooks and competitions
- **Hugging Face Spaces** for live model demos
- A portfolio site that ties it together ([How to Host Your Portfolio for Free](https://thetailorcv.com/blog/how-to-host-portfolio-free))
...
## Common Mistakes
- Accuracy obsession with no business framing
- Notebooks that will not run for anyone else
- No deployed demo
- Data leakage or no validation (instant red flag)
...
Very. A live demo someone can try is the strongest signal you can send. See [How to Host Your Portfolio for Free](https://thetailorcv.com/blog/how-to-host-portfolio-free).

### How do I align my resume?

Use the [Data Scientist Resume guide](https://thetailorcv.com/blog/data-scientist-resume-2026) and the [ML Engineer Resume guide](https://thetailorcv.com/blog/machine-learning-engineer-resume-2026).
