...
4. Key insights
5. Design goals
6. Wireframes or flows
7. Final solution
8. Impact or validation
9. Reflection
...
If the project was self-initiated, be clear about assumptions.
...
- Too many polished mockups with no process
...
Your resume should mention the same project with a concise result:

- Redesigned checkout flow in Figma after usability testing with 6 users, reducing prototype task completion time by 31%.
