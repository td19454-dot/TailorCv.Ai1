---
title: "Moving from a PhD into Industry in the US"
description: The hard part is not capability, it is translation: describing years of research in terms a hiring manager recognises, and adjusting to interviews that assess something academia never measured.
date: 2026-08-23
author: TailorCV Team
tags: [USA Jobs, New Grad, Career Advice, Job Search, Research]
category: Career Advice
image: public/blog-images/usa-phd-industry-transition-guide.png
slug: usa-phd-industry-transition-guide
keywords: phd to industry, leaving academia for industry, industry resume for phd, phd job search usa, postdoc alternative careers
showcase: portfolio
---
...
- For international candidates, [cap-exempt employers](/blog/usa-cap-exempt-h1b-employers) and the [O-1 route](/blog/usa-o1-visa-for-new-grads) are unusually accessible from a research background.
...
**Behavioural rounds are real and scored.** Conflict, failure, influencing someone, working to a deadline. Academics frequently arrive with no prepared examples because academic hiring does not test this. Build the [six stories](/blog/usa-behavioral-interview-star-campus) properly — this is the round PhDs most often lose.

**Technical rounds may not resemble your research.** Software roles will test algorithms under time pressure regardless of how much code you have written; data roles will test SQL and experiment design. The [technical preparation](/blog/usa-technical-interview-newgrad-prep) is a separate exercise from being good at your job, and it needs deliberate practice.
...
**Biology, chemistry, biomedical.** Biotechnology and pharmaceuticals in discovery and translational research, medical devices, computational biology, scientific software, and [clinical research roles at academic medical centres](/blog/usa-nursing-and-healthcare-new-grad-jobs).

**Engineering disciplines.** Industrial research and development, aerospace and defence, energy, semiconductors, and [national laboratories](/blog/usa-national-labs-and-research-jobs).
...
**Six months out, in parallel.** Build the [behavioural stories](/blog/usa-behavioral-interview-star-campus) and begin technical practice if your target roles test it. Both are separate from your research ability and both need deliberate work.
...
**Do this a year before you finish**, not in the final month. The [outreach approach](/blog/usa-cold-email-networking-students) applies, and it works particularly well here because a specific question about someone's work is exactly the kind of message researchers answer.
...
Summarise them in a line with a link. Keep the full academic CV for roles that ask, and for [cap-exempt research employers](/blog/usa-cap-exempt-h1b-employers), where the fuller record is genuinely read.

### What about the O-1 visa?

Worth assessing seriously if you are an international candidate with publications, citations and peer review. A doctoral record is the most common basis for a viable case — the [criteria are set out here](/blog/usa-o1-visa-for-new-grads).
