---
title: W2 vs 1099 in the US 2026 - Employee, Contractor, and What It Costs You
description: The difference between W2 employment, 1099 contracting, and corp-to-corp - who pays which taxes, what benefits you lose, and how to work out the rate you actually need to break even.
date: 2026-08-19
...
If you are still searching, start with the document doing the work — the [free ATS score checker](https://www.thetailorcv.com/solutions).
...
1. **Base salary** you want to match
2. **Add ~7.65%** for the employer half of payroll tax you now carry
3. **Add your health insurance cost** for the year — get an actual marketplace quote, do not estimate
4. **Add unpaid time off** — roughly 6% if you want three weeks
5. **Add the retirement match** you are giving up
6. **Divide by billable hours** — 2,080 hours in a year minus your unpaid time off, so roughly 1,960
...
**Contract-to-hire** is a common middle path: a contract period with the possibility of converting to permanent. It is a real route into companies that are cautious about headcount, and it moves faster than permanent hiring — see [the US job search timeline](https://thetailorcv.com/blog/us-job-search-timeline).

The wider question of whether contract or permanent fits your stage is covered in [contract vs full-time in the US](https://thetailorcv.com/blog/us-contract-vs-fulltime).
...
Whichever arrangement you take, the application starts the same way. [Check your ATS score free](https://www.thetailorcv.com/solutions).
...
Finally, get an accountant's hour before signing anything corp-to-corp, set aside money for quarterly estimated taxes from your first invoice, and label contract roles clearly on your resume so the pattern reads as deliberate. The wider stage-of-career question is in [contract vs full-time in the US](https://thetailorcv.com/blog/us-contract-vs-fulltime).
