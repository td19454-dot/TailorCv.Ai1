---
title: US Relocation Package Guide 2026 - What to Ask For and What It's Worth
description: Relocation support is negotiable and frequently not offered unless you ask. What a package typically covers, why lump sums are taxed, and the clawback clause people sign without reading.
date: 2026-08-20
...
If you are still interviewing, start with the document that gets you the offer — the [free ATS score checker](https://www.thetailorcv.com/solutions).
...
**Immigration and visa costs.** If you are relocating internationally, confirm who pays the application fees and the health surcharge equivalents — the employer covers some by law and others by negotiation. See [how to get a job in the USA as an international candidate](https://thetailorcv.com/blog/how-to-get-a-job-in-usa-international).

The practical settling-in problems that follow the move are covered in [relocating to the USA for work](https://thetailorcv.com/blog/relocating-to-usa-for-work).
...
**If they say there is no relocation budget**, ask for a signing bonus instead. It is the same money through a different line item, and signing bonuses are often easier to approve because they sit in a different budget. The wider approach is in [US salary negotiation](https://thetailorcv.com/blog/us-salary-negotiation-guide).
