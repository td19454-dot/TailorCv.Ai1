---
title: Notice Period Negotiation Guide 2026 - How to Leave Sooner
description: Notice periods are more negotiable than most people assume. What your contract actually obliges, how to ask for an earlier release, and how to manage a new employer who wants you next week.
date: 2026-08-12
...
If you are still lining up the next role, start with the [free ATS score checker](https://www.thetailorcv.com/solutions).
...
**Ask about the start date as part of negotiation.** It is one of the easiest things for an employer to grant - see [US salary negotiation](https://thetailorcv.com/blog/us-salary-negotiation-guide) or [UK salary negotiation](https://thetailorcv.com/blog/uk-salary-negotiation-guide) for how it fits into the wider package.
...
**A short gap is usually good.** A week or two between roles is worth taking - starting a new job rested rather than exhausted materially affects your first months, as [the first 90 days in a new job](https://thetailorcv.com/blog/first-90-days-new-job) covers.
...
Still lining up the next role? [Check your ATS score free](https://www.thetailorcv.com/solutions).
...
Finally, be honest with the incoming employer from the interview stage. State your actual contractual notice, give a realistic rather than optimistic date, and explain if it is long by local standards - most will accommodate it, and one who pressures you to breach your contract has told you something useful. Handle the resignation itself with [the resignation letter guide](https://thetailorcv.com/blog/resignation-letter-guide-2026), and if a counter-offer follows, see [should you accept a counter-offer](https://thetailorcv.com/blog/counter-offer-should-you-accept).
