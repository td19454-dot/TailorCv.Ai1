---
title: How to Negotiate a Job Offer Over Email (Scripts for 2026)
description: Negotiate salary and benefits by email without risking the offer. What to say, a word-for-word counteroffer script, and how to handle a firm "no".
date: 2026-07-15
author: TailorCV Team
tags: [Career Advice, Salary Negotiation, Job Offer, Career Growth, Job Search]
category: Career Advice
image: public/blog-images/how-to-negotiate-a-job-offer-email.webp
slug: how-to-negotiate-a-job-offer-email
keywords: negotiate job offer email, salary negotiation script, how to counteroffer, job offer negotiation 2026, negotiate salary email template, counteroffer email
---
...
[Employers](https://thetailorcv.com/blog/how-to-write-cold-email-to-recruiter) expect a counter and usually build in room for one. A polite, well-reasoned ask rarely costs you an offer that was genuinely coming — [companies](https://thetailorcv.com/blog/how-to-use-linkedin-for-job-search) do not rescind over a respectful negotiation. The downside is small; the upside compounds over every future raise, which is calculated from your starting number.
...
- **Salary databases and levels sites** for the [role](https://thetailorcv.com/blog/how-to-use-linkedin-for-job-search), level, and location.
...
- **Your network** — a discreet [question](https://thetailorcv.com/blog/common-interview-mistakes-to-avoid) to a peer in a similar [role](https://thetailorcv.com/blog/how-to-use-linkedin-for-job-search) is often the most accurate data of all.
...
- **A competing offer** is the strongest leverage. You do not have to name the [company](https://thetailorcv.com/blog/how-to-use-linkedin-for-job-search); "I'm weighing another offer" is enough.
- **Scarce, in-demand [skills](https://thetailorcv.com/blog/resume-skills-section-guide-2026)** give you room even without a competing offer.
...
- **Market data** that shows the offer is below range for the [role](https://thetailorcv.com/blog/how-to-use-linkedin-for-job-search).
...
- **Anchoring to personal need.** Rent and loans are not the [employer](https://thetailorcv.com/blog/how-to-write-cold-email-to-recruiter)'s lever; market value is.
- **Giving a range instead of a number.** [Employers](https://thetailorcv.com/blog/how-to-write-cold-email-to-recruiter) hear the bottom of your range. Give one clear number, slightly above target.
...
Once you settle on terms, confirm them in writing before you resign anywhere. A quick email — "Just confirming the base of [X], signing bonus of [Y], and start date of [Z]; excited to join!" — protects you and creates a clean record. Only after the final offer is documented should you [decline any other offers](https://thetailorcv.com/blog/how-to-decline-a-job-offer) and give notice at your current [role](https://thetailorcv.com/blog/how-to-use-linkedin-for-job-search).

## The Psychology of the Ask

The reason most people do not negotiate is fear — fear of seeming greedy, fear of the offer being pulled, fear of an awkward conversation. Understanding what is actually happening on the other side dissolves most of it. [Employers](https://thetailorcv.com/blog/how-to-write-cold-email-to-recruiter) expect a counter; many deliberately leave room for one, and a [candidate](https://thetailorcv.com/blog/how-to-write-resume-with-no-experience-2026) who negotiates reasonably is often respected *more*, not less, because it signals they know their value and will advocate well on the job too. The [company](https://thetailorcv.com/blog/how-to-use-linkedin-for-job-search) has already chosen you — they invested hours interviewing, they do not want to restart the search, and they are not going to torch that over a polite, well-reasoned ask. Reframe the negotiation not as a confrontation but as the first collaborative problem you and your future [employer](https://thetailorcv.com/blog/how-to-write-cold-email-to-recruiter) solve together: how do we structure this so you start motivated and fairly paid? Framed that way, it is not adversarial at all.
...
3. **Do your research:** market data for the [role](https://thetailorcv.com/blog/how-to-use-linkedin-for-job-search), level, and location, plus any competing-offer leverage.
...
You can redirect to your target range: "I'd rather focus on the value I'd bring to this [role](https://thetailorcv.com/blog/how-to-use-linkedin-for-job-search) — I'm targeting [X to Y] based on the market." In many places [employers](https://thetailorcv.com/blog/how-to-write-cold-email-to-recruiter) can no longer require salary history, and anchoring to your target is smarter regardless.
...
Pivot to the rest of the package: signing bonus, equity, extra PTO, remote flexibility, an earlier review date, or a title bump. Ask directly which elements are flexible. Many [companies](https://thetailorcv.com/blog/how-to-use-linkedin-for-job-search) with rigid salary bands have real room on these other levers.

### Should I get the final offer in writing before resigning?
Always. Confirm every agreed term — base, bonus, equity, start date — in writing and have the formal offer in hand before you resign from your current [role](https://thetailorcv.com/blog/how-to-use-linkedin-for-job-search) or decline any other offers. Verbal agreements occasionally fall through, and you never want to be left with nothing.

## Negotiating as a New Graduate or Career Starter

Early-career [candidates](https://thetailorcv.com/blog/how-to-write-resume-with-no-experience-2026) often assume they have no room to negotiate, and so they accept the first number without a word — leaving money on the table that compounds across every future raise. Even at [entry level](https://thetailorcv.com/blog/how-to-write-resume-with-no-experience-2026), a polite, well-reasoned ask is usually appropriate and rarely costs you the offer. The framing shifts slightly: with less [experience](https://thetailorcv.com/blog/first-time-resume-with-no-experience) to anchor to, lean harder on market data for the [role](https://thetailorcv.com/blog/how-to-use-linkedin-for-job-search) and location, on any competing offers, and on the specific [skills](https://thetailorcv.com/blog/resume-skills-section-guide-2026) or [projects](https://thetailorcv.com/blog/how-to-add-projects-in-resume-for-freshers) you bring. Keep the ask modest and gracious — "Based on my research for this kind of [role](https://thetailorcv.com/blog/how-to-use-linkedin-for-job-search), I was hoping we could get the base a little closer to [X]; is there any flexibility?" If the base is truly fixed, as it sometimes is for standardized new-grad programs, pivot to a signing bonus or an earlier review date. And remember that your starting salary sets the baseline for years of percentage raises, so a small increase now is worth far more than it appears. The worst outcome of a respectful ask is almost always just "no," and a graceful "understood, I'm still thrilled to accept" keeps everything warm.
