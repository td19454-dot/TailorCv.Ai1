...
- SQL (increasingly expected for senior PMs)
...
Go through the JD systematically.
List keywords from each layer.
This is your match target.
...
Tailor this for each role.
A growth PM role should front-load analytics.
A platform PM role should front-load integration and API terms.
...
**Listing responsibilities, not outcomes**
"Managed the roadmap" tells them nothing.
"Prioritized Q3 roadmap resulting in shipping 7 features that drove 20% retention improvement" tells them everything.
...
Adjust the language and examples to the target product type.
