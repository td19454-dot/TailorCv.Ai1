...
It is polite, specific, and does not demand immediate [referral](https://thetailorcv.com/blog/networking-tips-for-job-search). Many people are more comfortable responding when you ask for guidance first.

---

## What to Send If They Agree
...
- One-page resume
- 3-line fit summary
- Portfolio or [LinkedIn](https://thetailorcv.com/blog/how-to-use-linkedin-for-job-search) link if relevant

Make their effort small.
...
- Long life story
- Attaching resume in the first message to a cold contact
- Asking for multiple roles at once
- Sounding entitled
...
I am targeting roles where I can use [LinkedIn](https://thetailorcv.com/blog/how-to-use-linkedin-for-job-search) referral request, practical problem solving, and measurable execution to support business outcomes. My strongest examples include improving a process, building a project, coordinating with stakeholders, and using relevant tools to deliver a clearer result.
