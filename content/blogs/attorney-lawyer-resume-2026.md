---
title: Attorney & Lawyer Resume Guide 2026
description: Craft a legal resume that showcases practice areas, bar admissions, and case impact, with ATS keywords, structure, and examples.
date: 2026-07-26
author: TailorCV Team
tags: [legal, attorney, resume]
category: Job Search
image: public/blog-images/attorney-lawyer-resume-2026.webp
slug: attorney-lawyer-resume-2026
...
In law, your [resume](https://www.thetailorcv.com/modify-cv) is a writing sample. A single typo, an inconsistent citation, or a formatting slip signals carelessness in a profession where carelessness is unforgivable. Hiring partners read closely, and the [ATS](https://thetailorcv.com/blog/ats-score-guide) reads mechanically — so you need flawless precision and exact-match [keywords](https://thetailorcv.com/blog/how-to-match-resume-keywords-to-job-description). Get both right and you clear the two gates that filter out most applicants.

## Lead with bar admissions and credentials

List your **bar admissions** (with states and dates) prominently, along with your JD, law school, honors (law review, moot court, class rank if strong), and any clerkships. In law, these credentials are a primary screening filter, and the [ATS](https://thetailorcv.com/blog/ats-score-guide) treats them as high-value [keywords](https://thetailorcv.com/blog/how-to-match-resume-keywords-to-job-description). Use exact names — "Admitted to the New York State Bar (2022)" — and see [how to list certifications on a resume](https://thetailorcv.com/blog/how-to-list-certifications-on-resume) for formatting.

A tight [summary](https://thetailorcv.com/blog/how-to-write-resume-summary) sets the frame:

> "Corporate associate with 4 years at an AmLaw 100 firm, focused on M&A and private equity. Closed 20+ transactions worth a combined $3B. Admitted in New York and Delaware."

For the difference between a summary and an objective, see [resume objective vs summary](https://thetailorcv.com/blog/resume-objective-vs-summary).
...
Legal work is confidential, but you can still show scale and results using the [bullet point formula](https://thetailorcv.com/blog/how-to-write-resume-bullet-points) — a strong [action verb](https://thetailorcv.com/blog/best-action-verbs-for-resume), what you did, and a measurable outcome:

- "Managed a caseload of 40+ matters simultaneously."
- "Drafted and negotiated commercial contracts worth over $10M combined."
- "Won summary judgment in 8 of 10 dispositive motions."
- "Led a document review team of 6 across a complex litigation."

If your bullets read as duties, the [quantify achievements guide](https://thetailorcv.com/blog/how-to-quantify-achievements-on-resume) will sharpen them. Vague bullets are a common reason a strong candidate's [resume gets no responses](https://thetailorcv.com/blog/why-your-resume-gets-no-responses).

## Structure an attorney resume

1. **Header** — name, bar-admitted states, phone, email, city.
2. **Summary** — three lines, practice-area-forward.
3. **Bar admissions** — states and dates.
4. **Experience** — firm, role, and [quantified](https://thetailorcv.com/blog/how-to-quantify-achievements-on-resume) matter highlights.
5. **Education** — JD, honors, journal, moot court.
6. **Skills** — practice areas, tools (Relativity, Westlaw, LexisNexis, iManage).

This mirrors the layout in the [resume builder](https://www.thetailorcv.com/modify-cv), which handles formatting so your [resume](https://www.thetailorcv.com/modify-cv) stays clean. For section ordering, see the [resume section order guide](https://thetailorcv.com/blog/resume-section-order-guide).
...
Junior associates should aim for one page; experienced attorneys with substantial matter history can run two. Let relevance decide, as explained in the [ideal resume length guide](https://thetailorcv.com/blog/ideal-resume-length-guide) and [how far back your resume should go](https://thetailorcv.com/blog/how-far-back-should-resume-go). Every line should earn its place — quality over volume.

## New graduate or lateral move?

If you're a recent law graduate, lead with your JD, honors, journal, clerkships, and internships, and treat significant coursework and moot-court experience as real experience — the [resume with no experience guide](https://thetailorcv.com/blog/how-to-write-resume-with-no-experience-2026) shows how. If you're switching practice areas or moving in-house, reframe transferable skills using the [career change resume guide](https://thetailorcv.com/blog/career-change-resume-how-to-write-a-resume-when-switching-industries-in-2026), and tailor with the [resume optimizer](https://www.thetailorcv.com/solutions).
...
Avoid the errors that undercut otherwise strong candidates:
...
Legal compensation varies enormously by market, practice area, and firm size, so know your worth before you accept. Research market rates, and when an offer comes, negotiate professionally using [how to negotiate a salary offer](https://thetailorcv.com/blog/how-to-negotiate-salary-offer) and the [salary negotiation guide](https://thetailorcv.com/blog/salary-negotiation-guide). Consider the whole package — bonus structure, billable-hour expectations, partnership track, and benefits — not just base salary. If you're weighing multiple offers, [negotiating multiple job offers](https://thetailorcv.com/blog/negotiating-multiple-job-offers) explains how to do it without burning bridges.

## Attorney resume FAQ

**One page or two?**
Junior associates: one page. Experienced attorneys with substantial matter history: up to two. Let relevance decide, per the [ideal resume length guide](https://thetailorcv.com/blog/ideal-resume-length-guide).

**Should I list every case?**
No — highlight representative matters that show scope and results, kept [confidentiality-safe](https://thetailorcv.com/blog/how-to-quantify-achievements-on-resume). Quality over volume.

**How do I show impact without breaching confidentiality?**
Use aggregate figures — caseload size, deal values, win rates — rather than client names or privileged details.

**Do I need a different resume for firm vs in-house?**
Yes. Firms want billable expertise; in-house teams want business judgment. [Tailor each application](https://thetailorcv.com/blog/how-to-tailor-resume-in-5-minutes) and re-check with the [ATS score checker](https://www.thetailorcv.com/solutions).

**How important is proofreading, really?**
Critical. In law, a typo signals carelessness with filings. [Proofread](https://thetailorcv.com/blog/resume-proofreading-checklist) meticulously and run the [review checklist](https://thetailorcv.com/blog/resume-review-checklist-before-applying).
