...
I am targeting roles where I can use AI [job search](https://thetailorcv.com/blog/why-your-resume-gets-no-responses) workflow, practical problem solving, and measurable execution to support business outcomes. My strongest examples include improving a process, building a project, coordinating with stakeholders, and using relevant tools to deliver a clearer result.
