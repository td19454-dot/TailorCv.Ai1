...
Senior Customer Support Specialist with 5 years of experience in SaaS and e-commerce. Maintained 96% CSAT score across 1,200+ monthly tickets over 3 years. Reduced average first response time from 9 hours to 2.1 hours. Strong in Zendesk, Intercom, Salesforce, de-escalation, and building self-service knowledge bases. Experienced in onboarding, technical support, and billing dispute resolution.
...
CRM and Helpdesk: Zendesk, Intercom, Freshdesk, Salesforce Service Cloud, HubSpot CRM, Jira Service Management
Communication: Written and verbal communication, active listening, de-escalation, empathy, clarity
Resolution Skills: Issue triage, root cause analysis, escalation management, SLA compliance
Self-Service: Knowledge base authoring, FAQ development, chatbot scripting, video guides
Metrics: CSAT, NPS, first contact resolution (FCR), average handle time (AHT), MTTR tickets
Industries: SaaS, e-commerce, fintech, telecom, healthcare, retail, hospitality

---

## Best ATS Keywords for Customer Service Resume
...
- Complaint handling
- CRM
- Team leadership (for lead roles)
- Quality assurance (QA)

---

## How to Write Customer Service Resume Bullet Points

Formula:

Maintained / Reduced / Created / Managed + [support metric or process] + [ticket volume or customer context] + [CSAT, FCR, response time, or efficiency outcome]

### Weak Bullet Points

- Helped customers with their issues
- Used Zendesk to manage tickets
- Handled complaints
