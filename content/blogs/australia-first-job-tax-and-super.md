---
title: "Your First Australian Job - Tax, Super and Your First Payslip"
description: A TFN, a super fund, and the difference between a salary quoted as base and one quoted as a package. The administrative things that decide what actually lands in your account.
date: 2026-08-24
author: TailorCV Team
tags: [Australia Jobs, New Grad, Career Advice, Personal Finance]
category: Career Advice
image: public/blog-images/australia-first-job-tax-and-super.png
slug: australia-first-job-tax-and-super
keywords: australia tax file number, superannuation explained, australia payslip explained, tax free threshold australia, first job australia tax
showcase: none
---
...
- [ ] TFN applied for and provided to your employer
- [ ] Tax File Number Declaration completed
- [ ] Tax-free threshold claimed on one job only
- [ ] Super fund chosen, or the default understood
- [ ] Old super accounts consolidated through myGov
- [ ] Offer confirmed as base-plus-super or package
- [ ] First payslip checked, including the super line
- [ ] myGov account set up and linked to the ATO
- [ ] Work-related receipts kept from the start
