...
Read the [ideal resume length guide](https://thetailorcv.com/blog/ideal-resume-length-guide) for length guidance at each stage.
...
For a full rewrite, use [how to write a resume from scratch](https://thetailorcv.com/blog/how-to-write-resume-from-scratch) as your guide and start from a fresh [ATS-friendly template](https://www.thetailorcv.com/templates).
...
Run it through the [TailorCV ATS checker](https://www.thetailorcv.com/solutions) right now to see your score and identify specific gaps.
...
- [ ] Has the summary been refreshed?
- [ ] Are there new achievements to add?
