...
Three to four references formatted this way is plenty. The "can speak to" line is the secret weapon — it quietly steers each reference toward the strengths most relevant to the role, and it signals to the employer that you chose your references deliberately.

## How to Brief a Reference Well

A briefed reference gives a specific answer; an unbriefed one gives a vague one. Before you list someone, send them a short note:
...
This does three things: it refreshes their memory, it aligns their answer with what the employer cares about, and it warns them a call may be coming so they respond promptly.

## Who Makes a Weak Reference

- **A big title who barely knew you.** "The VP" sounds impressive but gives a generic answer that helps no one.
...
The best reference is a recent manager or close colleague who can describe specific results in their own words.
