---
title: Should You Put References on Your Resume? (2026 Answer)
description: Whether to include references or "references available on request" in 2026, how to prepare a separate reference sheet, and how to brief your references.
date: 2026-07-15
author: TailorCV Team
tags: [Resume Writing, References, Job Search, Career Advice, Application Tips]
category: Resume Writing
image: public/blog-images/should-you-put-references-on-resume.webp
slug: should-you-put-references-on-resume
keywords: references on resume, should i include references, references available on request, resume references 2026, reference sheet, job references
---
...
Leave references off your [resume](https://thetailorcv.com/blog/anatomy-of-a-resume) entirely. Space on a [resume](https://thetailorcv.com/blog/anatomy-of-a-resume) is scarce, and references are only relevant at the offer stage — long after the [resume](https://thetailorcv.com/blog/anatomy-of-a-resume) has done its job. Listing them early gives away nothing useful and wastes room you could use for a stronger bullet.

## Skip "References Available on Request" Too

This line is a relic. Everyone knows you will provide references if asked, so the phrase adds no information and quietly signals an outdated [resume](https://thetailorcv.com/blog/anatomy-of-a-resume). Delete it and use the line for something that helps you get the [interview](https://thetailorcv.com/blog/ai-mock-interview-complete-guide-2026).
...
The best reference is someone who directly supervised or worked closely with you and can speak to specific results. A senior title who barely knew you is weaker than a direct [manager](https://thetailorcv.com/blog/common-interview-mistakes-to-avoid) who can say "she rebuilt our reporting pipeline." Aim for two to four references, ideally including at least one recent [manager](https://thetailorcv.com/blog/common-interview-mistakes-to-avoid).
...
When an [employer](https://thetailorcv.com/blog/how-to-write-cold-email-to-recruiter) asks, send a clean document whose header matches your [resume](https://thetailorcv.com/blog/anatomy-of-a-resume), so the two look like a set. For each reference:
...
A briefed reference gives a specific [answer](https://thetailorcv.com/blog/ai-mock-interview-complete-guide-2026); an unbriefed one gives a vague one. Before you list someone, send them a short note:

> "Thanks again for being a reference! I'm interviewing for a [Role] at [Company] that emphasizes [key skills]. If it helps, two things I'd love for you to mention if it comes up: [win 1] and [win 2]. I'll let you know if they reach out."

This does three things: it refreshes their memory, it aligns their [answer](https://thetailorcv.com/blog/ai-mock-interview-complete-guide-2026) with what the [employer](https://thetailorcv.com/blog/how-to-write-cold-email-to-recruiter) cares about, and it warns them a call may be coming so they respond promptly.
...
The best reference is a recent [manager](https://thetailorcv.com/blog/common-interview-mistakes-to-avoid) or close colleague who can describe specific results in their own words.
...
Understanding what happens on the other end helps you prepare the right people. When an [employer](https://thetailorcv.com/blog/how-to-write-cold-email-to-recruiter) reaches the reference stage, they are rarely looking for dirt — they are looking to confirm what they already believe and to fill in any gaps. A typical reference call covers a handful of predictable [questions](https://thetailorcv.com/blog/common-interview-mistakes-to-avoid):
